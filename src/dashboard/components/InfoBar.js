    ...
    return [
      <div key="infobar" className="card">
        <div className="card-body d-flex align-items-center px-0 pl-3 py-0">
          <p className="my-0">
            Streamgraph is using <strong>{this.props.sampleCount.toLocaleString()}</strong> filtered samples taken <strong>{this.props.sampleMethod}</strong> (<strong>{(this.props.sampleCount / this.props.totalCount).toLocaleString('en-US', {style: "percent", minimumFractionDigits: 4})}</strong>)
          </p>
